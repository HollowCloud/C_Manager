...
public class Cinema {
    ...
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);
            ...
            // Going through array, making right symbols all over the array
            ...
            // Giving client the opportunity to choose
            int answer = 1;
            while (true) {
    ...
    public static void buyATicket(int rows, int seats, String[][] cinema) {
    	Scanner scanner = new Scanner(System.in);
    	// asking for clients row and seat numbers
    	boolean answer = true;
    	int pickedRow = 0;
    	int pickedSeat = 0;
    	while(answer) {
    ...
    public static void statistics(int rows, int seats, String[][] cinema) {
    	// going through the list and checking how much tickets are bought
//    	int tickets = 0;
//    	for (int i = 0; i < cinema.length; i++) {
//        	for (int j = 0; j < cinema[i].length; j++) { 
//        		if (cinema[i][j] == "B ") {
...
//        	}
//        }
    	// declaring variable totalSeats with information about total Seats of the cinema, ticketPrice for 1 ticket price, and ticketSum for total price for sold tickets.
